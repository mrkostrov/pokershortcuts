; This open source code by Xander was added to Shortcuts in version 4.0032 after Shortcuts was converted to open source.
; It is more robust than the code used in earlier versions of Shortcuts.
...
;		GoSub, %window%
   ...
   if NOT (CasinoName := CasinoName(id,A_ThisFunc))
      return
   ...
   WindowScaledPos(vTX, vTY, ClientScaleFactor, "Screen", id)
...
TableRight() {
   title := "ahk_group Tables"
;outputdebug, in nextwindow_right
